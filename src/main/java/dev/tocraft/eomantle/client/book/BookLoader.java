package dev.tocraft.eomantle.client.book;
...
import dev.tocraft.eomantle.client.book.action.protocol.ProtocolGoToPage;
import dev.tocraft.eomantle.client.book.data.BookData;
import dev.tocraft.eomantle.client.book.data.content.ContentBlank;
import dev.tocraft.eomantle.client.book.data.content.ContentBlockInteraction;
import dev.tocraft.eomantle.client.book.data.content.ContentCrafting;
import dev.tocraft.eomantle.client.book.data.content.ContentImage;
import dev.tocraft.eomantle.client.book.data.content.ContentImageText;
import dev.tocraft.eomantle.client.book.data.content.ContentIndex;
import dev.tocraft.eomantle.client.book.data.content.ContentPadding;
import dev.tocraft.eomantle.client.book.data.content.ContentShowcase;
import dev.tocraft.eomantle.client.book.data.content.ContentSmelting;
import dev.tocraft.eomantle.client.book.data.content.ContentSmithing;
import dev.tocraft.eomantle.client.book.data.content.ContentStructure;
import dev.tocraft.eomantle.client.book.data.content.ContentText;
import dev.tocraft.eomantle.client.book.data.content.ContentTextImage;
import dev.tocraft.eomantle.client.book.data.content.ContentTextLeftImage;
import dev.tocraft.eomantle.client.book.data.content.ContentTextRightImage;
import dev.tocraft.eomantle.client.book.data.content.PageContent;
import dev.tocraft.eomantle.client.book.data.deserializer.ConditionDeserializer;
import dev.tocraft.eomantle.client.book.data.deserializer.HexStringDeserializer;
import dev.tocraft.eomantle.client.book.data.element.IngredientData;
...
import dev.tocraft.eomantle.client.book.transformer.IndexTransformer;
...
public class BookLoader implements ResourceManagerReloadListener {
  ...
  public BookLoader() {
    ...
    registerGsonTypeAdapter(ResourceLocation.class, ResourceLocationSerializer.resourceLocation("eomantle"));
