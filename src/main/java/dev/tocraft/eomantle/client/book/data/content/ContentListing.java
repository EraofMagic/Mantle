...
import dev.tocraft.eomantle.client.book.transformer.ContentListingSectionTransformer;
import dev.tocraft.eomantle.client.screen.book.BookScreen;
import dev.tocraft.eomantle.client.screen.book.TextDataRenderer;
import dev.tocraft.eomantle.client.screen.book.element.BookElement;
import dev.tocraft.eomantle.client.screen.book.element.ListingLeftElement;
...
public class ContentListing extends PageContent {
  ...
  public void addEntry(String text, @Nullable PageData link, boolean subSection) {
    ...
    if (link != null) {
      data.action = "eomantle:go-to-page-rtn " + link.parent.name + "." + link.name;
    }
