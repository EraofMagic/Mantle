...
import dev.tocraft.eomantle.client.screen.book.element.TooltipElement;

import java.util.ArrayList;

import static dev.tocraft.eomantle.client.screen.book.Textures.TEX_SMELTING;
...
public class ContentSmelting extends PageContent {
  ...
  public void build(BookData book, ArrayList<BookElement> list, boolean rightSide) {
    ...
    list.add(new TooltipElement(ImmutableList.of(Component.translatable("eomantle:tooltip.cooktime", this.cookTime / 20)), x + 7, y + 42, 60, 28));
