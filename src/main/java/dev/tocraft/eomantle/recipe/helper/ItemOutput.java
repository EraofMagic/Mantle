package dev.tocraft.eomantle.recipe.helper;
...
import dev.tocraft.eomantle.data.loadable.LoadableCodec;
...
public abstract class ItemOutput implements Supplier<ItemStack> {
  ...
  public enum Loadable implements dev.tocraft.eomantle.data.loadable.Loadable<ItemOutput> {
