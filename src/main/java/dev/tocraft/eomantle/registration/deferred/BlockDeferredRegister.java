...
import dev.tocraft.eomantle.item.BurnableBlockItem;
import dev.tocraft.eomantle.item.BurnableSignItem;
import dev.tocraft.eomantle.item.BurnableTallBlockItem;
