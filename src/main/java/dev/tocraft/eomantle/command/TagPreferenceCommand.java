...
public class TagPreferenceCommand {
  private static final String EMPTY_TAG = "command.eomantle.tag_preference.empty_tag";
  private static final String PREFERENCE = "command.eomantle.tag_preference.preference";
