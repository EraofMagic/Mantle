package dev.tocraft.eomantle.fluid.tooltip;
...
import dev.tocraft.eomantle.data.gson.TagKeySerializer;
...
public class FluidTooltipHandler extends SimpleJsonResourceReloadListener {
  ...
  public static final String FOLDER = "eomantle/fluid_tooltips";
  /** GSON instance */
