...
public class GenericLoaderRegistry<T extends IHaveLoader> implements Loadable<T> {
  ...
  /** @deprecated use {@link RecordLoadable}. Will fully replace it in 1.20. */
  @Deprecated
   ...
   * TODO 1.20: replace with {@link IAmLoadable.Record}
   */
  public interface IHaveLoader {
    /**
     * Gets the loader for the object.
     * If you wish to suppress the deprecation warning, change the return type to {@link RecordLoadable}.
     */
